...
WHERE
    d.connection_id = $1
    AND t.timestamp >= (CURRENT_DATE AT TIME ZONE 'Asia/Kolkata' AT TIME ZONE 'UTC' - INTERVAL '1 month')
    AND t.timestamp < (CURRENT_DATE AT TIME ZONE 'Asia/Kolkata' AT TIME ZONE 'UTC' + INTERVAL '1 day')
GROUP BY
    day
ORDER BY
    day;
